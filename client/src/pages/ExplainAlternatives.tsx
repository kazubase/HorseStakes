...
export default function ExplainAlternatives() {
  ...
  const { data: alternatives, isLoading } = useQuery<AlternativesResponse>({
    queryKey: [`/api/betting-explanation/${id}/alternatives`],
    enabled: !!id,
  });
        ...
        <div className="grid gap-6">
          ...
          <Card>
            ...
            <CardContent className="prose prose-sm max-w-none">
              <p className="whitespace-pre-wrap">{alternatives?.summary}</p>
            </CardContent>
          </Card>

          {/* 代替戦略リスト */}
          {alternatives?.strategies.map((strategy, index) => (
            <Card key={index}>
              <CardHeader>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <Progress 
                      ...
                      className="h-2 mt-4"
                      style={{
                        background: `hsl(${100 - strategy.riskLevel}, 100%, 30%)`,
                      }}
                    />
                    <p className="text-sm text-muted-foreground mt-1">
          ...
          <Card>
            ...
            <CardContent>
              <Table>
                ...
                <TableBody>
                  {alternatives?.comparisonMetrics.map((metric, index) => (
                    <TableRow key={index}>
