    ...
    return (<MainLayout>
      ...
      <div className="grid gap-4 md:grid-cols-3">
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className={"text-2xl font-bold ".concat(summary.roi >= 0 ? 'text-green-500' : 'text-red-500')}>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              {summary.recentResults.map(function (result, index) { return (<div key={index} className="flex justify-between items-center">
                  ...
                  <p className={"text-sm font-bold ".concat(result.return > result.invested ? 'text-green-500' : 'text-red-500')}>
