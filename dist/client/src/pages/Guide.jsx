        ...
        <div className="relative">
          ...
          <div className="hidden md:flex items-center gap-3 absolute bottom-4 left-4 text-muted-foreground">
            <div className="bg-primary/10 p-3 rounded-full">
              <img src="/horseshoe-icon2.PNG" alt="馬蹄アイコン" className="h-6 w-6"/>
            </div>
            <div>
          ...
          <Card>
            <CardContent className="space-y-6 pt-6">
              <div className="space-y-12">
                <div>
                  <img src="/betting-generation.png" alt="馬券候補の生成プロセス" className="w-full max-w-lg mx-auto dark:opacity-90"/>
                  <p className="text-sm text-muted-foreground mt-4">単勝、複勝など全ての馬券種別について期待値と的中確率を計算し、有望な候補を抽出します</p>
                </div>

                <div>
                  <img src="/ai-analysis.png" alt="AI分析プロセス" className="w-full max-w-lg mx-auto dark:opacity-90"/>
                  <p className="text-sm text-muted-foreground mt-4">期待値、的中確率、相関関係、リスク分散を考慮して最適な馬券の組み合わせを分析します</p>
                </div>

                <div>
                  <img src="/fund-optimization.png" alt="資金配分の最適化プロセス" className="w-full max-w-lg mx-auto dark:opacity-90"/>
