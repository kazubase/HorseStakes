...
export function setupVite(app, server) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, createViteServer(__assign(__assign({}, viteConfig), { configFile: false, customLogger: __assign(__assign({}, viteLogger), { error: function (msg, options) {
                                if (msg.includes("[TypeScript] Found 0 errors. Watching for file changes")) {
                                    log("no errors found", "tsc");
                                    return;
                                }
                                if (msg.includes("[TypeScript] ")) {
                                    var _a = msg.split("[TypeScript] ", 2), errors = _a[0], summary = _a[1];
                                    log("".concat(summary, " ").concat(errors, "\u001B[0m"), "tsc");
                                    return;
                                }
                                else {
